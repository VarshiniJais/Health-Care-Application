              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                      icon: SvgPicture.network(
                        'https://raw.githubusercontent.com/VarshiniJais/Health-Care-Application/main/Google_Drive-Logo.wine.svg',
                        width: 40,
                        height: 40,
                      ),
                      onPressed: () => setState(() {
                        _launched =
                            _launchInBrowser('https://drive.google.com/drive/folders/1pUHrN1tiRzP0vrIDLGYw5Md5y62qdDm4?usp=share_link');
                      }),
                    ),
                    const SizedBox(width: 8),
                    IconButton(
                      ...
                      onPressed: () => setState(() {
                        _launched =
                            _launchInBrowser('https://github.com/VarshiniJais/Health-Care-Application');
                      }),
                    ),
                    const SizedBox(width: 8),
                  ],
